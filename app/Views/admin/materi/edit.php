...
$selectedKelas = old('id_kelas', $materi['id_kelas'] ?? '');
?>
      ...
      <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section class="mb-8 overflow-hidden rounded-2xl border border-amber-100 bg-white/90 p-6 shadow-xl backdrop-blur-sm sm:p-8">
          ...
          <p class="mt-4 max-w-2xl text-sm leading-6 text-stone-600 sm:text-base">
            Perbarui informasi materi pembelajaran yang tersedia pada platform SekulLegend.
          </p>
        </section>
          ...
          <div class="overflow-hidden rounded-2xl border border-burlap-200 bg-white/90 shadow-md backdrop-blur-sm">
            <div class="border-b border-burlap-200 bg-burlap-50 px-6 py-4">
              ...
              <p class="mt-1 text-sm text-stone-500">
                Kosongkan file jika tidak ingin mengganti file materi.
              </p>
            </div>

            <div class="p-6">
              <form action="<?= base_url('admin/materi/update/' . ($materi['id'] ?? '')) ?>" method="post" enctype="multipart/form-data" class="space-y-5">
                <?= csrf_field() ?>
                ...
                <div>
                  ...
                  >
                    ...
                    <?php foreach ($kelas as $k) : ?>
                      <option value="<?= esc($k['id'] ?? '') ?>" <?= (string) $selectedKelas === (string) ($k['id'] ?? '') ? 'selected' : '' ?>>
                        <?= esc($k['nama_kelas'] ?? '-') ?>
                      </option>
                    <?php endforeach; ?>
                  </select>
