...
<body class="bg-burlap-50 font-sans min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden mb-8">
            <div class="md:flex">
                <div class="p-8">
                    ...
                    <h1 class="mt-2 text-3xl font-bold text-stone-800">Tambah Kelas</h1>
                    <p class="mt-3 text-stone-600">Tambahkan kelas baru ke platform SekulLegend.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6">
                <form action="<?= base_url('admin/kelas/simpan') ?>" method="post" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="nama_kelas" class="block text-sm font-medium text-stone-700 mb-1">Nama Kelas</label>
                            <input type="text" name="nama_kelas" id="nama_kelas" placeholder="Contoh: Bahasa Indonesia Kelas X" required 
                            ...
                            <p class="mt-1 text-xs text-stone-500">Masukkan nama lengkap kelas</p>
                        </div>
                        <div>
                            <label for="kode_kelas" class="block text-sm font-medium text-stone-700 mb-1">Kode Kelas</label>
                            <input type="text" name="kode_kelas" id="kode_kelas" placeholder="Contoh: B-IND10" required 
                                class="w-full px-3 py-2 border border-burlap-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            <p class="mt-1 text-xs text-stone-500">Masukkan kode unik untuk kelas</p>
                        </div>
                    </div>
                    <div>
                        <label for="id_guru" class="block text-sm font-medium text-stone-700 mb-1">Pilih Guru Pengajar</label>
                        ...
                        <p class="mt-1 text-xs text-stone-500">Pilih guru yang akan mengajar di kelas ini</p>
                    </div>
                    <div class="flex justify-end pt-4">
                        <a href="<?= base_url('admin/kelas') ?>" class="px-4 py-2 bg-stone-200 text-stone-800 rounded-lg mr-2 font-medium hover:bg-stone-300 transition">
                            Batal
                        </a>
