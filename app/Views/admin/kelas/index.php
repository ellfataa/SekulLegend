...
<head>
  ...
  <title>Manajemen Kelas - SekulLegend</title>
      ...
      <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <section class="mb-8 overflow-hidden rounded-2xl border border-amber-100 bg-white/90 p-6 shadow-xl backdrop-blur-sm sm:p-8">
          ...
          <p class="mt-4 max-w-2xl text-sm leading-6 text-stone-600 sm:text-base">
            Kelola seluruh kelas yang tersedia pada platform SekulLegend.
          </p>
        </section>
        ...
        <section class="overflow-hidden rounded-2xl border border-burlap-200 bg-white/90 shadow-md backdrop-blur-sm">
          <div class="border-b border-burlap-200 bg-burlap-50 px-6 py-4">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <a
                href="<?= base_url('admin/kelas/tambah') ?>"
            ...
            <?php if (empty($kelas)) : ?>
              <div class="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p class="mt-2 text-sm text-stone-500">
                  Tambahkan kelas baru untuk mulai mengelola pembelajaran.
                </p>
              </div>
            <?php else : ?>
                  ...
                  <article class="rounded-xl border border-burlap-200 bg-white p-5 shadow-sm transition hover:bg-burlap-50/40 hover:shadow-md">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div class="flex items-start gap-3">
                          ...
                          <div class="min-w-0">
                            ...
                            <div class="mt-2 flex flex-col gap-2 text-sm text-stone-600 sm:flex-row sm:flex-wrap sm:items-center">
                              <span>
                                <span class="font-medium text-stone-700">Kode:</span>
                                <span class="font-mono"><?= esc($k['kode_kelas'] ?? '-') ?></span>
                              </span>

                              <?php if (! empty($k['nama_guru'])) : ?>
                                <span class="hidden text-stone-300 sm:inline">•</span>
                                <span>
                                  <span class="font-medium text-stone-700">Guru:</span>
                                  <?= esc($k['nama_guru']) ?>
                                </span>
                              <?php endif; ?>
                            </div>
                      ...
                      <div class="flex flex-col gap-2 sm:flex-row lg:justify-end">
                        <a
                          href="<?= base_url('admin/kelas/edit/' . ($k['id'] ?? 0)) ?>"
                        ...
                        <a
                          href="<?= base_url('admin/kelas/hapus/' . ($k['id'] ?? 0)) ?>"
                          onclick="return confirm('Yakin ingin menghapus kelas ini? Semua materi dan diskusi terkait juga dapat ikut terhapus.')"
